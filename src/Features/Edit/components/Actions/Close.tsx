...
> = (): React.ReactElement => {
  ...
  const DisplayFileSelection = async () => {
    if (selectedFiles.length > 0) {
      ...
      send('actionClose', {}, Object.assign({}, q, {}), {
        selectedFiles,
      });
    }
    setdisplaySelectedFiles(false);
        ...
        >
          <AcceptValidationStyled>
            <div className="card-items">
              ...
              >{`
              Sélectionner les fichiers à clôturer :`}</h2>
          ...
          <div className="card-items">
            <h2 style={{ fontSize: 18, fontWeight: 600 }} className="font">
              {selectedFiles.length === 1
                ? "Vous êtes sur le point d'effectuer la clôture des dossier:"
                : "Vous êtes sur le point d'effectuer la clôture des dossiers :"}
            </h2>
