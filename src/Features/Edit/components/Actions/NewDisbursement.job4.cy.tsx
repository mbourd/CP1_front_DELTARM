...
// NOTE: Run CLI:
// yarn cypress:run:component --browser chrome --config video=false --spec "src/Features/Edit/components/Actions/NewDisbursement.job4.cy.tsx"
...
describe('<NewDisbursement />', function () {
  it('should render without crash', function () {
    ...
    cy.react('Button').contains('Nouveau décaissement').should('exist');
  });
  ...
  it('should make one request at a time payload/queries not empty', function () {
    ...
    cy.intercept('POST', '/file/new_dec\\?*', (req) => {
      reqCount2++;
      req.reply({ statusCode: 200, body: {} });
    }).as('reqPostNewDecFile');
