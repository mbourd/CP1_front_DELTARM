      ...
      controls: [
        {
          ...
          regex: '^(i?)aut\\d{6}$',
          regexMsg:
            "Le Numéro d'Autorisation doit comporter : AUT + 6 chiffres",
