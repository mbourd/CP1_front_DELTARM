...
export default {
  title: 'Features/Edit/components/Control/Form/Financial/FinancialControl',
  ...
  tags: ['autodocs'],
  argTypes: {},
} as Meta<typeof FinancialControl>;

type Story = StoryObj<typeof FinancialControl>;
