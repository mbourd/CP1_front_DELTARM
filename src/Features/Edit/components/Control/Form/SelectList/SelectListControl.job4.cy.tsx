...
// NOTE: Run CLI:
// yarn cypress:run:component --browser chrome --config video=false --spec "src/Features/Edit/components/Control/Form/SelectList/SelectListControl.cy.tsx"
...
describe('<SelectListControl />', () => {
  ...
  it('should render <ControlLabel /> and <ControlFooter/>', () => {
    ...
    cy.waitReactApp();
    cy.react('SelectListControl').react('ControlLabel');
    cy.react('SelectListControl').react('ControlFooter');
  });
  ...
  it('should render <RejectControl /> if useRejection & control_rejectable', () => {
    ...
    cy.waitReactApp();
    cy.react('SelectListControl').react('RejectControl');
  });
});
