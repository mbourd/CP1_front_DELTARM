...
export default {
  title: 'Features/Edit/components/Control/Form/JoditRichText/JoditRichTextControl',
  ...
  tags: ['autodocs'],
  argTypes: {},
} as Meta<typeof JoditRichTextControl>;

type Story = StoryObj<typeof JoditRichTextControl>;
