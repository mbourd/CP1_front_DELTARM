...
export default {
  title: 'Features/Edit/components/Control/Form/DateTime/DateTimeControl',
  ...
  tags: ['autodocs'],
  argTypes: {},
} as Meta<typeof DateTimeControl>;

type Story = StoryObj<typeof DateTimeControl>;
