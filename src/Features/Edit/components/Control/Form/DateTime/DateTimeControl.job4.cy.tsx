...
// NOTE: Run CLI:
// yarn cypress:run:component --browser chrome --config video=false --spec "src/Features/Edit/components/Control/Form/DateTime/DateTimeControl.job4.cy.tsx"
    ...
    cy.mount(
      ...
      .then(() => {
        cy.window()
          .then((window) => {
            window[
              'Features/Edit/Control/Form/DateTime/DateTimeControl'
