...
export const ComplianceFooter: React.FC<IProps> = ({ compliance }): React.ReactElement => {
  return (
    <Box position="relative">
      <Grid className={'compliance-footer'} container component={'span'} alignItems={'center'} wrap={'nowrap'}>
