...
// NOTE: Run CLI:
// yarn cypress:run:component --browser chrome --config video=false --spec "src/Features/Edit/components/Control/Form/Compliance/FormCompliance/ComplianceFooter.job2.cy.tsx"
...
describe('<ComplianceFooter />', () => {
  ...
  it('should render compliance_elm_desc_2 in tooltip', () => {
    const title = 'Hello';
    const _compliance = {
      ...structuredClone(compliance),
