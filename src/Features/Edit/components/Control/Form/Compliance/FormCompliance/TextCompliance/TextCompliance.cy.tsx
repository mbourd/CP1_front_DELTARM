  ...
  it('should render', () => {
    ...
    mount(
      <SetupTestsComponents>
        <TextCompliance compliance={_compliance} fileId={''} controlId={''} />
      </SetupTestsComponents>,
    );
    cy.waitReactApp();
