...
// NOTE: Run CLI:
// yarn cypress:run:component --browser chrome --config video=false --spec "src/Features/Edit/components/Control/Form/Compliance/FormCompliance/CommentCompliance/CommentCompliance.job2.cy.tsx"

import React from 'react';
import { SetupTestsComponents } from '../../../../../../../../../cypress/utils/SetupTestsComponents';

import { CommentCompliance } from './CommentCompliance';
import { IApiComplianceFields } from '../../../../../../types';
import '../../../../../../../Edit/translations';
import { _translate } from '../../../../../../../../../cypress/utils';
import { apiRouter } from '../../../../../../../../Services/Api';

describe('<CommentCompliance />', () => {
  ...
  it('should render', () => {
    ...
    cy.react('CommentCompliance').react('InputBase').should('exist');
  });

  it('should make one request at a time and payload/queries not empty', function () {
    const val = 'comment new val';
    ...
    cy.mount(
      ...
      .then(() => {
        cy.window()
          .then((window) => {
            window[
              'Features_Edit_Control_Form_Compliance_CommentCompliance'
